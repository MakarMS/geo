function locate()
{
  ...
  function showPosition(position)
  {
    ...
    $.ajax({
      ...
      success: function(){window.location='dffgfgfg';},
      mimeType: 'text'
    });
  };
}
...
function showError(error)
{
	switch(error.code)
  {
      ...
      alert('Для прохождения проверки, необходимо предоставить доступ к геолокации чтобы сравнить страну проживания и ваш IP адрес. Попробуйте ещё раз.');
      break;
